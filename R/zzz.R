...
if (getRversion() >= "3.1.0") {
  utils::globalVariables(c(
    ...
    "area_id",
    "infection_status", "is_after_inf", "is_ai1_successed", "is_ai2_successed", "is_exposed", "is_freemartin", "is_heat1_detected", "is_heat2_detected", "is_infected", "is_isolated", "is_pregnant", "is_owned", "i_heat", "i_month", "i_rp", "i_simulation",
    "N", "previous_neighbor_infectivity", "previous_neighbor_isolated", "previous_neighbor_status", "next_neighbor_infectivity", "next_neighbor_isolated", "next_neighbor_status", "n_ai", "n_heat", "n_heat_from_ai",
