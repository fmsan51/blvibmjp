...
set_capacity <- function(herd_size) {
  if (!is.na(PARAMS_FARM$capacity_head[1])) {
    capacity <- PARAMS_FARM$capacity_head
  } else if (!is.na(PARAMS_FARM$capacity_multiple[1])) {
    capacity <- round(c(herd_size * PARAMS_FARM$capacity_multiple[1],
                        herd_size * PARAMS_FARM$capacity_multiple[2]))
  } else {
